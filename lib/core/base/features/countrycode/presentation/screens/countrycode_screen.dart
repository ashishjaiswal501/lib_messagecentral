...
class CountryCodeDropDown<T extends CountryData> extends StatefulWidget {
...
class _CountryCodeDropDownDropDownState<T extends CountryData>
  ...
  Widget build(BuildContext context) {
    ...
    //                   entry.key < widget.optionLabels!.length
    //               ? widget.optionLabels![entry.key]
    //               : '${entry.value.name} (${entry.value.isoCountryCode})',
    //         ),
    //       ),
    // );
    ...
    final optionToDisplayValue = Map.fromEntries(
      widget.options.asMap().entries.map((option) => MapEntry(
          ...
          widget.optionLabels == null ||
              ...
              ? '${option.value.name} (${option.value.phoneCode})'
