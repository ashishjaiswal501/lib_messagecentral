...
class CustomTextStyle {
  static TextStyle getFont(Color fontColor, double size, FontWeight weight) {
    return TextStyle(color: fontColor, fontSize: size, fontWeight: weight);
  }
}

FFButtonOptions getFFButtonOptions(
    Color btnColor, Color textColor, Color borderColor, double elevation) {
  return FFButtonOptions(
    height: 44.0,
    color: btnColor,
    textStyle: CustomTextStyle.getFont(textColor, 14.0, FontWeight.w600),
    elevation: 0.0,
