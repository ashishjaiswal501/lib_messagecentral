...
import 'package:messagecentral/core/language/bloc/app_bloc.dart';
    ...
    return ScreenUtilInit(
      ...
      builder: (context, child) {
        return MultiBlocProvider(
          providers: [
            BlocProvider(create: (context) => AppBloc(appLanguage!.appLocale)),
            ...
            locale: state.locale,
              ...
              GlobalCupertinoLocalizations.delegate,
                  ...
                  theme: ThemeData(
                    ...
                    useMaterial3: false,
                    hintColor: const Color(0xFF98A1B0),
