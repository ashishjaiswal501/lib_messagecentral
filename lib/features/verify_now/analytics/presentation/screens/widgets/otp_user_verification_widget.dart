...
class OtpUserVerificationWidget extends StatefulWidget {
  const OtpUserVerificationWidget({super.key});

  @override
  State<OtpUserVerificationWidget> createState() =>
      _OtpUserVerificationWidgetState();
}

class _OtpUserVerificationWidgetState extends State<OtpUserVerificationWidget> {
                    ...
                    Padding(
                      ...
                      child: ElevatedButton(
                        style: ElevatedButton.styleFrom(
                            minimumSize: Size(30.w, 63), elevation: 0),
                        onPressed: () {
                          downloadFile(
