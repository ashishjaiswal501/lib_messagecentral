...
class OtpServiceScreen extends StatefulWidget {
  const OtpServiceScreen({super.key});

  @override
  State<OtpServiceScreen> createState() => _OtpServiceScreenState();
}

class _OtpServiceScreenState extends State<OtpServiceScreen> {
  ...
  void initState() {
    ...
    MixPanelAnalyticsManager()
        .sendEvent('OTP_Service_landing', 'OTP Service landing', null);
    setScreenFirebase('OTP_Service_landing', 'OTP Service landing');
  }
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
                        ...
                        builder: (context) => InkWell(
                          ...
                          onTap: () async {
                            MixPanelAnalyticsManager().sendEvent(
                                'OTP_service_date_range',
                                'OTP Service date range',
                                null);
          ...
          BlocBuilder<OtpAnalyticsCubit, OtpAnalyticsState>(
                      ...
                      children: [
                        ...
                        GridWidget(
                          childrengridItem: [
                            ...
                            GlobalWidgets.buildGridItem(
                              title: 'OTP Verified',
                              value: analytics.analyticsData?.verified
                                      ?.toString() ??
                                  "0",
                            ...
                            GlobalWidgets.buildGridItem(
                              title: 'Verified Rate',
                              value:
                                  "${analytics.analyticsData?.verifiedPercentage?.toStringAsFixed(1) ?? 0}%",
