...
part of 'details_reporting_entity.dart';
...
/// @nodoc
mixin _$DetailsReportingEntity {
  int? get responseCode => throw _privateConstructorUsedError;
  String? get message => throw _privateConstructorUsedError;
  ReportingData? get data => throw _privateConstructorUsedError;

  @JsonKey(ignore: true)
  $DetailsReportingEntityCopyWith<DetailsReportingEntity> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $DetailsReportingEntityCopyWith<$Res> {
  factory $DetailsReportingEntityCopyWith(DetailsReportingEntity value,
          $Res Function(DetailsReportingEntity) then) =
      _$DetailsReportingEntityCopyWithImpl<$Res, DetailsReportingEntity>;
  @useResult
...
/// @nodoc
class _$DetailsReportingEntityCopyWithImpl<$Res,
        $Val extends DetailsReportingEntity>
    implements $DetailsReportingEntityCopyWith<$Res> {
  _$DetailsReportingEntityCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$DetailsReportingEntityImplCopyWith<$Res>
    implements $DetailsReportingEntityCopyWith<$Res> {
  factory _$$DetailsReportingEntityImplCopyWith(
          _$DetailsReportingEntityImpl value,
          $Res Function(_$DetailsReportingEntityImpl) then) =
      __$$DetailsReportingEntityImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({int? responseCode, String? message, ReportingData? data});
...
/// @nodoc
class __$$DetailsReportingEntityImplCopyWithImpl<$Res>
    extends _$DetailsReportingEntityCopyWithImpl<$Res,
        _$DetailsReportingEntityImpl>
    implements _$$DetailsReportingEntityImplCopyWith<$Res> {
  __$$DetailsReportingEntityImplCopyWithImpl(
      _$DetailsReportingEntityImpl _value,
      $Res Function(_$DetailsReportingEntityImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$DetailsReportingEntityImpl(
      responseCode: freezed == responseCode
          ? _value.responseCode
          : responseCode // ignore: cast_nullable_to_non_nullable
              as int?,
...
class _$DetailsReportingEntityImpl implements _DetailsReportingEntity {
  const _$DetailsReportingEntityImpl(
  ...
  @override
  String toString() {
    return 'DetailsReportingEntity(responseCode: $responseCode, message: $message, data: $data)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$DetailsReportingEntityImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$DetailsReportingEntityImplCopyWith<_$DetailsReportingEntityImpl>
      get copyWith => __$$DetailsReportingEntityImplCopyWithImpl<
          _$DetailsReportingEntityImpl>(this, _$identity);
}

abstract class _DetailsReportingEntity implements DetailsReportingEntity {
  const factory _DetailsReportingEntity(
      {final int? responseCode,
      final String? message,
      final ReportingData? data}) = _$DetailsReportingEntityImpl;
