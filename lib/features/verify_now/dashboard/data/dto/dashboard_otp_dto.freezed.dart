...
DashboardOtpDto _$DashboardOtpDtoFromJson(Map<String, dynamic> json) {
  return _DashboardOtpDto.fromJson(json);
}

/// @nodoc
mixin _$DashboardOtpDto {
  ...
  @JsonKey(ignore: true)
  $DashboardOtpDtoCopyWith<DashboardOtpDto> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $DashboardOtpDtoCopyWith<$Res> {
  factory $DashboardOtpDtoCopyWith(
          DashboardOtpDto value, $Res Function(DashboardOtpDto) then) =
      _$DashboardOtpDtoCopyWithImpl<$Res, DashboardOtpDto>;
  @useResult
  $Res call(
...
/// @nodoc
class _$DashboardOtpDtoCopyWithImpl<$Res, $Val extends DashboardOtpDto>
    implements $DashboardOtpDtoCopyWith<$Res> {
  _$DashboardOtpDtoCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$DashboardOtpDtoImplCopyWith<$Res>
    implements $DashboardOtpDtoCopyWith<$Res> {
  factory _$$DashboardOtpDtoImplCopyWith(_$DashboardOtpDtoImpl value,
          $Res Function(_$DashboardOtpDtoImpl) then) =
      __$$DashboardOtpDtoImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "responseCode") int? responseCode,
...
/// @nodoc
class __$$DashboardOtpDtoImplCopyWithImpl<$Res>
    extends _$DashboardOtpDtoCopyWithImpl<$Res, _$DashboardOtpDtoImpl>
    implements _$$DashboardOtpDtoImplCopyWith<$Res> {
  __$$DashboardOtpDtoImplCopyWithImpl(
      _$DashboardOtpDtoImpl _value, $Res Function(_$DashboardOtpDtoImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$DashboardOtpDtoImpl(
      responseCode: freezed == responseCode
          ? _value.responseCode
          : responseCode // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$DashboardOtpDtoImpl implements _DashboardOtpDto {
  const _$DashboardOtpDtoImpl(
      {@JsonKey(name: "responseCode") this.responseCode,
      @JsonKey(name: "message") this.message,
      @JsonKey(name: "data") this.data});

  factory _$DashboardOtpDtoImpl.fromJson(Map<String, dynamic> json) =>
      _$$DashboardOtpDtoImplFromJson(json);
  ...
  @override
  String toString() {
    return 'DashboardOtpDto(responseCode: $responseCode, message: $message, data: $data)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$DashboardOtpDtoImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$DashboardOtpDtoImplCopyWith<_$DashboardOtpDtoImpl> get copyWith =>
      __$$DashboardOtpDtoImplCopyWithImpl<_$DashboardOtpDtoImpl>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$DashboardOtpDtoImplToJson(
      this,
    );
  }
}

abstract class _DashboardOtpDto implements DashboardOtpDto {
  const factory _DashboardOtpDto(
      {@JsonKey(name: "responseCode") final int? responseCode,
      @JsonKey(name: "message") final String? message,
      @JsonKey(name: "data") final Data? data}) = _$DashboardOtpDtoImpl;

  factory _DashboardOtpDto.fromJson(Map<String, dynamic> json) =
      _$DashboardOtpDtoImpl.fromJson;
