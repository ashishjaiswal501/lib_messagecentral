...
class SuccessPopupWidgetRequestAlreadyExists extends StatefulWidget {
  const SuccessPopupWidgetRequestAlreadyExists({super.key});

  @override
  State<SuccessPopupWidgetRequestAlreadyExists> createState() =>
      _SuccessPopupWidgetRequestAlreadyExistsState();
}

class _SuccessPopupWidgetRequestAlreadyExistsState
    extends State<SuccessPopupWidgetRequestAlreadyExists> {
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              Flexible(
                                child: Text(
                                  "Request Already Exist for CustomerId ${LocalStateCache().customerId}",
