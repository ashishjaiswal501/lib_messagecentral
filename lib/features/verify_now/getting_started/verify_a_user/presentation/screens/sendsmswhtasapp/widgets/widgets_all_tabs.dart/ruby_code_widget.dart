...
class RubyCodeWidget extends StatelessWidget {
  String sendOtpRequest =
      "require \"uri\"\nrequire \"net/http\"\n\nurl = URI(\"${FlavorConfig.instance!.values!.baseUrl}verification/v3/send?countryCode=${LocalStateCache().countryCode}&customerId=${LocalStateCache().customerId}&flowType=WHATSAPP&mobileNumber=${LocalStateCache().phoneNo}\")\n\nhttp = Net::HTTP.new(url.host, url.port);\nrequest = Net::HTTP::Post.new(url)\n\nrequest[\"authToken\"] = \"***********\"\n\nresponse = http.request(request)\nputs response.read_body";
