...
VerifyAUserDto _$VerifyAUserDtoFromJson(Map<String, dynamic> json) {
  return _VerifyAUserDto.fromJson(json);
}

/// @nodoc
mixin _$VerifyAUserDto {
  ...
  @JsonKey(ignore: true)
  $VerifyAUserDtoCopyWith<VerifyAUserDto> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $VerifyAUserDtoCopyWith<$Res> {
  factory $VerifyAUserDtoCopyWith(
          VerifyAUserDto value, $Res Function(VerifyAUserDto) then) =
      _$VerifyAUserDtoCopyWithImpl<$Res, VerifyAUserDto>;
  @useResult
  $Res call(
...
/// @nodoc
class _$VerifyAUserDtoCopyWithImpl<$Res, $Val extends VerifyAUserDto>
    implements $VerifyAUserDtoCopyWith<$Res> {
  _$VerifyAUserDtoCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$VerifyAUserDtoImplCopyWith<$Res>
    implements $VerifyAUserDtoCopyWith<$Res> {
  factory _$$VerifyAUserDtoImplCopyWith(_$VerifyAUserDtoImpl value,
          $Res Function(_$VerifyAUserDtoImpl) then) =
      __$$VerifyAUserDtoImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "responseCode") int? responseCode,
...
/// @nodoc
class __$$VerifyAUserDtoImplCopyWithImpl<$Res>
    extends _$VerifyAUserDtoCopyWithImpl<$Res, _$VerifyAUserDtoImpl>
    implements _$$VerifyAUserDtoImplCopyWith<$Res> {
  __$$VerifyAUserDtoImplCopyWithImpl(
      _$VerifyAUserDtoImpl _value, $Res Function(_$VerifyAUserDtoImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$VerifyAUserDtoImpl(
      responseCode: freezed == responseCode
          ? _value.responseCode
          : responseCode // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$VerifyAUserDtoImpl implements _VerifyAUserDto {
  const _$VerifyAUserDtoImpl(
      {@JsonKey(name: "responseCode") this.responseCode,
      @JsonKey(name: "message") this.message,
      @JsonKey(name: "data") this.data});

  factory _$VerifyAUserDtoImpl.fromJson(Map<String, dynamic> json) =>
      _$$VerifyAUserDtoImplFromJson(json);
  ...
  @override
  String toString() {
    return 'VerifyAUserDto(responseCode: $responseCode, message: $message, data: $data)';
  }
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$VerifyAUserDtoImplCopyWith<_$VerifyAUserDtoImpl> get copyWith =>
      __$$VerifyAUserDtoImplCopyWithImpl<_$VerifyAUserDtoImpl>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$VerifyAUserDtoImplToJson(
      this,
    );
  }
}

abstract class _VerifyAUserDto implements VerifyAUserDto {
  const factory _VerifyAUserDto(
      {@JsonKey(name: "responseCode") final int? responseCode,
      @JsonKey(name: "message") final String? message,
      @JsonKey(name: "data") final Data? data}) = _$VerifyAUserDtoImpl;

  factory _VerifyAUserDto.fromJson(Map<String, dynamic> json) =
      _$VerifyAUserDtoImpl.fromJson;
